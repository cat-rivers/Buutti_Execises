...
const calculateAreaOfTriangle = (object) =>{
  const area = (object.length * object.width)/2
  return area
  }

  let firstArea = calculateAreaOfTriangle(triangles[0])
  let secondArea = calculateAreaOfTriangle(triangles[1])
  let thirdArea = calculateAreaOfTriangle(triangles[2])
