...
const hello2 = (language2) => {
  if (language2 === "es") { console.log("Hola mundo!");}
  if (language2 === "eng") {  console.log("Hello world!");}
  if (language2 === "fi") { console.log("Hei Maailman!");}
};
...
function languageHello(language3) {
  switch (language3) {
    case "es":  console.log("Hola mundo");
      break;
    case "eng": console.log("Hello world");
      break;
    case "fi":  console.log("Hei maailman!");
      break;
